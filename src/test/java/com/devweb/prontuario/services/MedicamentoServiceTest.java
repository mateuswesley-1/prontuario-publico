...
//import com.devweb.prontuario.repositories.jbdc.MedicamentoRepository;
...
//        this.underTest = new MedicamentoService ( this.dao );
//    }
//    @AfterEach
...
//    @Test
//    void delete() {
//        when(this.dao.findById ( "medicamentoId" ))
...
//        //Then
//        verify ( this.dao ).delete ( "medicamentoId" );
//    }
//
//    @Test
//    void update() {
...
//                50.0f
//        );
//        when ( this.dao.findById ( "medicamentoId") ).thenReturn ( Optional.of ( atual ) );
//
//        //When: deve chamar repo.save com os novos dados
//        this.underTest.update ( "medicamentoId", att );
//
