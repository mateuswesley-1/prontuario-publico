...
class MedicamentoServiceTest {
    private MedicamentoService underTest;
    @Mock
    ...
    void setUp() {
        ...
        this.underTest = new MedicamentoService ( this.repository );
    }
    @AfterEach
    ...
    void getAllShouldReturnRepositoryResultWithoutChanges() {
        ...
        //When
        Page<Medicamento> result = underTest.getAll ( pageable );
    ...
    void getByIdShouldReturnRepositoryResultWithoutChanges() {
        ...
        //When
        Medicamento result = this.underTest.getById ( "id" );
    ...
    void getByIdShouldThrowErrorWhenIdDoesNotExist() {
        ...
        assertEquals ( Medicamento.class.getName () + " não encontrado.", throwable.getMessage () );
    }
    ...
    @Test
    void delete() {
        when(this.repository.findById ( "medicamento_id" ))
                .thenReturn ( Optional.of ( new Medicamento (
                        "diazepan",
                        50.0f
                ) ) );
        //When
        this.underTest.delete ( "medicamento_id" );
        //Then
        verify ( this.repository ).delete ( "medicamento_id" );
    }
    ...
    void update() {
        ...
        when ( this.repository.findById ( "medicamento_id") ).thenReturn ( Optional.of ( atual ) );

        //When: deve chamar repo.save com os novos dados
        this.underTest.update ( "medicamento_id", att );
